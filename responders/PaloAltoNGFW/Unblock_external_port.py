...
class Unblock_port(Responder):
    def __init__(self):
        ...
        self.name_external_Service_Group = self.get_param('config.name_external_Service_Group','TheHive Black list external port')
    ...
    def run(self):
        ...
        self.report({'message': 'Responder comlited, deleted %s from %s' % (port,self.name_external_Service_Group)})
