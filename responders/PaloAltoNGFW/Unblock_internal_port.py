...
class Unblock_port(Responder):
    def __init__(self):
        ...
        self.name_internal_Service_Group = self.get_param('config.name_internal_Service_Group','TheHive Black list internal port')
    ...
    def run(self):
        ...
        self.report({'message': 'Responder comlited, deleted %s from %s' % (port,self.name_internal_Service_Group)})
