...
class Unblock_ip(Responder):
    def __init__(self):
        ...
        self.name_internal_Address_Group = self.get_param('config.name_internal_Address_Group',"TheHive Black list internal IP")
    ...
    def run(self):
        ...
        self.report({'message': 'Responder comlited, deleted %s from %s' % (ioc,self.name_internal_Address_Group)})
