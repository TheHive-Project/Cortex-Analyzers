...
class CensysAnalyzer(Analyzer):
    ...
    def search(self, search):
        """
        Searches for hosts in Certificate base
        ...
        :return: dict
        """
        h = CensysCerts(api_id=self.__uid, api_secret=self.__api_key)
        ...
        for page in h.search(search, per_page=self.__per_page, pages=self.__pages, fields=fields):
    ...
    def summary(self, raw):
        ...
        if 'matches' in raw:
            ...
            taxonomies.append(self.build_taxonomy('info', 'CensysV2 cert search', 'results', result_count))
